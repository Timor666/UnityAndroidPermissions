...
[CreateAssetMenu(fileName = "PermissionInfos", menuName = "Timor/Android/权限清单")]
[SerializeField]
public class PermissionInfos : ScriptableObject
{
    ...
    public PermissionInfos()
    {
        string[] fullName = new string[]
        {
            ...
            "ndroid.permission.CHANGE_CONFIGURATION",
        ...
        {
            "允许读写访问Properties表在checkin数据库中，改值可以修改上传",
        ...
        Infos = new PermissionInfo[fullName.Length];

        for (int i = 0; i < fullName.Length; i++)
        {
            Infos[i] = new PermissionInfo();
            Infos[i].FullName = fullName[i];
            Infos[i].Describe = des[i];
        }
    }
}